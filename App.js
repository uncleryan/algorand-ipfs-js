...
const IPFSWrapper = require("./src/IPFSWrapper");
...
async function globalMain() {
  ...
  // const ipfs = new IPFSWrapper(process.env.ENCRYPTION_PASSWORD);
  // await ipfs.init();

  // const client = new algosdk.Algodv2(
  //   ALGOD_CONFIG.algodToken,
  //   ALGOD_CONFIG.algodServer,
  //   ALGOD_CONFIG.algodPort
  // );
  ...
  // console.log(`SK: ${generatedAccount.sk}`);
